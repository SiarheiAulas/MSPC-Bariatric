...
class PrimaryDataStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
             ...
             'bleedwithin30daysofsurgery'=>'numeric|min:0|max:1|digits_between:1,1',
             'fundingcategory'=>'required|numeric|min:1|max:3|digits_between:1,1',
